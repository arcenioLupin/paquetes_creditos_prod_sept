        ...
        IF cuota = 1 THEN
            ...
            ln_fec_vcto := CASE WHEN lv_ind_pgra_sint = 'S' THEN 
                        --ADD_MONTHS(ln_fec_vcto, ln_val_meses_periodo + (ln_can_dias_venc_1ra_letr/ln_val_dias_periodo))
                         ADD_MONTHS(ln_fec_vcto, trunc(ln_can_dias_venc_1ra_letr/ln_val_dias_periodo))  --<I Req. 87567 E2.1 ID 69 AVILCA 24/07/2020>
                       ELSE
    ...
    (
        ...
        CASE
             WHEN p_val_ind_sin_int = 'S' THEN
                ADD_MONTHS(SYSDATE, trunc(p_can_dias_venc_1ra_letr/30))--<I Req. 87567 E2.1 ID 69 AVILCA 25/08/2020>
             ELSE
